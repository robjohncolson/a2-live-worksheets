...
-- Source of truth: roster-server/migrations/*.sql (25 migrations).
...
-- 0040_a2_teacher_entry.sql
DO $migration$
BEGIN
  IF EXISTS (SELECT 1 FROM a2._bootstrap_migrations WHERE name = '0040_a2_teacher_entry.sql' AND digest <> '40c0f3bbb27f0f5a72d83b5f43d50f75e4f0b5f01b99436e718fdcaaa30169c1') THEN
    RAISE EXCEPTION 'Applied migration 0040_a2_teacher_entry.sql changed; author a new migration instead';
  END IF;
  IF NOT EXISTS (SELECT 1 FROM a2._bootstrap_migrations WHERE name = '0040_a2_teacher_entry.sql') THEN
...
$$;
    INSERT INTO a2._bootstrap_migrations(name, digest) VALUES ('0040_a2_teacher_entry.sql', '40c0f3bbb27f0f5a72d83b5f43d50f75e4f0b5f01b99436e718fdcaaa30169c1');
  END IF;
END;
$migration$;
